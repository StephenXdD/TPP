...
# Example usage
input_directory = "output_cleaned_2"  # Change to your input directory
# Specify how many copies for each page (for example, for 2 pages: [3, 4])
duplicates = [8, 3]  # Change these values for your 2 sheets
